...
RED.deploy = (function() {
    ...
    function init(options) {
            ...
            $(`
                <li>
                    <span class="red-ui-deploy-button-group button-group">
                        <a id="red-ui-header-button-release" class="red-ui-deploy-button" href="#">
                            <span class="red-ui-deploy-button-content">
                                <img src="red/images/eos-icons--deploy.svg">
                                <span>发布</span>
                            </span>
                        </a>
                    </span>
        ...
        $('#red-ui-header-button-release').on("click", function(event) {
            event.preventDefault();
            alert("发布到正式环境");
        });
